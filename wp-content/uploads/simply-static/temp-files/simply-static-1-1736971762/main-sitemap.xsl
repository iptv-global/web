			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Global IPTV</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Global IPTV</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://iptv-global.github.io/web/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
